...
const Sidebar = () => {
  return (
    <div className="bg-[#003a10] min-h-screen pl-[4vw] ">
      <a href={import.meta.env.VITE_CLIENT} target="_blank" rel="noreferrer">
        <img
          src={assets.logo}
      ...
      <div className="flex flex-col gap-5 mt-10">
        <NavLink
          to={"/add-song"}
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] text-sm drop-shadow-[-4px_4px_#00ff5b] font-medium "
        >
